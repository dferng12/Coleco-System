...
public class Messages implements Initializable {
    ...
    @FXML
    private ListView<Model.Message> messages;
    ...
    public void setUser(User user) {
        ...
        mail.addUser(user);
        ObservableList<Model.Message> observableList = FXCollections.observableArrayList();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        messages.getSelectionModel().selectedItemProperty().addListener((observable, oldClickedSubject, clickedMessage) -> {
            ...
            try {
                ...
                Message messageView = loader.getController();

                messageView.setData(clickedMessage);
                st.show();
            } catch (IOException e) {
                e.printStackTrace();
            }
